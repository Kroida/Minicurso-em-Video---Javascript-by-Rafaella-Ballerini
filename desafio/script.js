...
function adicionarTarefa() {
    ...
    if (tarefa == "") {
        ...
        // Remove a classe "desativado" do botão de limpar, tornando-o visível
        botaoLimpar.classList.remove("desativado");
...
function limparLista() {
    ...
    botaoLimpar.classList.add("desativado"); // Adiciona a classe "desativado" ao botão de limpar, tornando-o invisível
